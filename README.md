...
![Latest Release Version](https://img.shields.io/badge/dynamic/json?labelColor=grey&color=6366f1&label=Latest%20released%20version&url=https%3A%2F%2Fraw.githubusercontent.com%2Frizrmd%2Fbreezify%2Fv4.x%2Fversions.json&query=coolify.v4.version&style=for-the-badge
...
```bash
curl -fsSL https://raw.githubusercontent.com/rizrmd/breezify/v4.x/scripts/install.sh | sudo bash -s --
```
